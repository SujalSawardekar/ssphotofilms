  ...
  return (
    <section className="relative w-full py-24 md:py-32 overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto py-24">
        ...
        >
          <h2 className="text-white font-cinzel text-lg sm:text-3xl md:text-5xl lg:text-6xl font-bold tracking-[0.1em] md:tracking-[0.2em] mb-6 uppercase whitespace-nowrap">
